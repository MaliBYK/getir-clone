...
const Offers: React.FC<{
  ...
  width: any;
  height: any;
}> = ({ arrows, slidesToShow, width, height }) => {
  ...
  return (
    <div className='container mx-auto md:mt-8'>
      <h3 className='subtitle hidden md:block mb-3'>Kampanyalar</h3>
      <div className='md:hidden flex items-center justify-center py-5 bg-primary'>
        <img
      ...
      <div className='md:hidden flex justify-between text-xl cursor-pointer items-center p-2 bg-white text-primary'>
        <div className=' flex items-center'>
          <HiLocationMarker />
          <span className='text-sm select-none text-gray-600 font-semibold ml-2'>
          ...
          {banners.map(({ id, image }) => (
            <div key={String(id)}>
              <img
                loading='lazy'
                width={width}
                className='md:rounded-md max-w-full max-h-full object-contain'
                src={image}
              />
            </div>
          ))}
