...
const Header = () => {
  return (
    <header className='bg-primary-dark w-full h-10 md:h-11 '>
      <div className='container mx-auto flex items-center h-full justify-between'>
        <nav className='flex space-x-[2px] items-center h-full md:pt-2'>
          <a href='#' className='ml-2 navLink active'>
            <img
        ...
        <nav className=' gap-x-8 items-center text-sm hidden md:flex'>
          <a
            href='#'
            className='text-white text-opacity-80 hover:text-opacity-100 transition-all flex gap-x-2 items-center'
          >
